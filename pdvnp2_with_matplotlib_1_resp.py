...
class pdvnp(wx.Frame):
    def __init__(self, parent, id):
        ...
        self.p = wx.Panel(sp,style=wx.SUNKEN_BORDER)
        self.p2 = wx.Panel(sp,style=wx.SUNKEN_BORDER)
            
        self.p2.Hide()
        self.p.wx.SetBackgroundColour("sky blue")
        self.p2.wx.SetBackgroundColour("sky blue")
        self.sp.Initialize(p)
        self.sp.SetMinimunPaneSize(10)
    ...
    def OnAbrirImage1(self,event):
        ...
        if dialog.ShowModal() == wx.ID_OK:
            ...
            #self.plt.imshow(ellipses)
            
            #plt.imshow(ellipses)
            #self.imread('/home/falvarez/matwork/E61EXT_MIG.jpg')
            #self.canvas = FigureCanvas(self, wx.ID_ANY, self.figure)
