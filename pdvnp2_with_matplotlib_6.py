...
##    global win
    def __init__(self):
        global win,win_bita,txt_bitapatch,txt_bita,Lta_mode

        #Atributos globales de Bitacora
        global bita
        ##,rutaGuardado,nombredearchivobitacora,modo,usuario
...
##        wx.Frame.__init__(self, parent, title=title)
        ...
        txt_bita       = wx.TextCtrl(win_bita,-1,"bitacora.log",(300,50),size=(175, -1))
        
        lbl_bitapatch  = wx.StaticText(win_bita,-1,"Ruta donde se guarda los archivos:",(80,80))
        txt_bitapatch  = wx.TextCtrl(win_bita,-1,os.environ['HOME'],(300,80),size=(175, -1))
        ...
        bita = bitacora2.bitacora()
##        print bitacora2.bitacora.modo
        bitacora2.bitacora.modo = Lta_mode.GetString(Lta_mode.GetSelection())
...
##        except (NameError, ValueError):
            ...
            bita.construirmensaje('DEBUG','JEJEJEJ')
            print "Error"
