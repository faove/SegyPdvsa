...
##        print bita.guardaResumen
        ...
        lbl_bitaNMf  = wx.StaticText(win_bita,-1,"Numero Maximo de lineas:",(80,150))
        txt_bitaNMf  = wx.TextCtrl(win_bita,-1,bita.NumeroMaximoDeMensajes,(300,150),size=(175, -1))
        
        #NombreDeArchivoTot
        lbl_bitaNAT  = wx.StaticText(win_bita,-1,"Nombre del archivo de Totalizacion:",(80,200))
        txt_bitaNAT  = wx.TextCtrl(win_bita,-1,bita.NombreDeArchivoTot,(300,200),size=(175, -1))
        ...
        che_bitagua  = wx.CheckBox(win_bita,-1,"Bandera Totalizacion",(80, 250),(180,20))
...
##            print "AQUI"
##            print  che_bitagua.IsChecked()
            
            arch.Modificar(txt_bitapatch.Value,txt_bita.Value,Lta_mode.GetString(Lta_mode.GetSelection()),os.environ['USERNAME'],txt_bitaNMf.Value,txt_bitaNAT.Value,str(che_bitagua.IsChecked()))
            a = arch.Abrir()
...
##            print win_bita.txt_bita
            ...
            bita.construirmensaje(sys.argv[0],sys.exc_info()[1],'INFO','Revisar')
